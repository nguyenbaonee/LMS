...
public enum ErrorCode {
    ...
    AVATAR_MAIN_NOT_FOUND(4002,"response.student.avatarMainNotFound",HttpStatus.BAD_REQUEST),
    AVATAR_DELETE_NOT_FOUND(4001,"response.student.avatarDeleteNotFound",HttpStatus.BAD_REQUEST),
    ...
    DONT_ACTIVE(3001,"response.user.dont_active",HttpStatus.BAD_REQUEST),
